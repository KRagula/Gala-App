			...
			<div className='SafetyAreaWrapper'>
				<div className='SafetyArea'>
					...
					<div className='SafetyPaper' id='SafetyPaper'>
						...
						<br />
						<br />
						Each offer of experience requires a thorough vetting process including a submission of
						proof.
						<br />
						<br />
						Gala's platform also uses an escrow service to guarantee that the offerer receives
						payment upon completion of experience.
						<br />
						<br />
